<?php
global $post;
$mv_slider_link_text = get_post_meta( $post->ID, 'mv_slider_link_text', true );
$mv_slider_link_url = get_post_meta( $post->ID, 'mv_slider_link_url', true );
?>
    ...
    <tr>
        ...
        <td>
            <input 
                ...
                value="<?php echo $mv_slider_link_text; ?>"
                required
            >
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input 
                ...
                value="<?php echo $mv_slider_link_url; ?>"
                required
            >
        </td>
    </tr>               
